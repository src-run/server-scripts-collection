...
function compile_printer_self_name() {
  ...
  cli_style @style:bold @fg:black "$(
    basename "${temp:-${name}}" 2>/dev/null || print_txt "${name}"
  )"
}
...
function compile_printer_defs_char() {
  ...
  case "${1}" in
    crit) decs='@fg:white @bg:red @style:bold' ;;
...
print_def crit 'this is %d %sof type "%s"...' 1 'message string' crit
print_def fail 'this is %d %sof type "%s"...' 1 'message string' fail
print_def warn 'this is %d %sof type "%s"...' 1 'message string' warn
print_def note 'this is %d %sof type "%s"...' 1 'message string' note
print_def info 'this is %d %sof type "%s"...' 1 'message string' info
print_def debg 'this is %d %sof type "%s"...' 1 'message string' debg
print_def unkn 'this is %d %sof type "%s"...' 1 'message string' unkn
